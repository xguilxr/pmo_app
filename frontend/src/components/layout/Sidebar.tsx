...
import { logout, isSuperAdmin } from '../../services/auth';
import {
  LayoutDashboard,
  FolderKanban,
  FileText,
    ...
    <aside className="w-[260px] sidebar-gradient border-r border-sidebar-border h-screen flex flex-col fixed left-0 top-0 z-20">
      ...
      <div className="px-5 py-5 border-b border-sidebar-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-[15px] font-medium text-white tracking-tight">PMOAAS</h1>
            <p className="text-[10px] text-sidebar-text/50 font-light uppercase tracking-widest">
              {superAdmin ? 'Super Admin' : 'Project Management'}
            </p>
          </div>
        </div>
      </div>
